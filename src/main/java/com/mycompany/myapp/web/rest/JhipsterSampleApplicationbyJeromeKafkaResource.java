...
@RestController
@RequestMapping("/api/jhipster-sample-applicationby-jerome-kafka")
public class JhipsterSampleApplicationbyJeromeKafkaResource {
    private final Logger log = LoggerFactory.getLogger(JhipsterSampleApplicationbyJeromeKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JhipsterSampleApplicationbyJeromeKafkaResource(KafkaProperties kafkaProperties) {

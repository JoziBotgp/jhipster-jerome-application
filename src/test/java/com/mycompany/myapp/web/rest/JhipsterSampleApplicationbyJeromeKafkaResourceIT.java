...
class JhipsterSampleApplicationbyJeromeKafkaResourceIT {
    ...
    void setup() {
        ...
        JhipsterSampleApplicationbyJeromeKafkaResource kafkaResource = new JhipsterSampleApplicationbyJeromeKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/jhipster-sample-applicationby-jerome-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/jhipster-sample-applicationby-jerome-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
